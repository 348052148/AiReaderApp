...
import 'package:aireder/pages/home.dart';
import 'package:aireder/pages/login.dart';
import 'package:aireder/pages/search.dart';
import 'package:aireder/pages/set.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: <String, WidgetBuilder>{
        ...
        '/book': (BuildContext context) => new BookDetailPage(),
        '/book_shelf': (BuildContext context) => new BookShelfPage(),
        '/book_list': (BuildContext context) => new BookListPage(),
